...
import be.bvl.poc.IntegrationTest;
import be.bvl.poc.config.Constants;
import be.bvl.poc.domain.User;
import be.bvl.poc.repository.AuthorityRepository;
...
import be.bvl.poc.service.dto.PasswordChangeDTO;
import be.bvl.poc.web.rest.vm.KeyAndPasswordVM;
import be.bvl.poc.web.rest.vm.ManagedUserVM;
